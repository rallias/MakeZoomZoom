...
public class TransformTRCE implements IClassTransformer {
    @Override
...
//                System.out.println(ASMHelper.getMethodAsString(methodNode));
                ...
                replacementList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "xyz/ajp/makezoomzoom/asmreimpl/cofh/thermalexpansion/plugins/jei/machine/transposer/TransposerRecipeCategoryExtract", "getRecipes", "(Lmezz/jei/api/IGuiHelper;Lmezz/jei/api/ingredients/IIngredientRegistry;)Ljava/util/List;", false));
